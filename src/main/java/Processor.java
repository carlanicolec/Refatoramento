	...
	public  void determineAction(String args[]) {
        try {
            ...
            if (act.equals("enroll")) {
                ...
                GoodHealth health = new GoodHealth();///goodhealth
                health.GoodHealth(10);
                moves = 0;
                gameStart = true;
                ...
                newLine();
                System.out.println("Where - see where you can move next");
                newLine();
                ...
                newLine();
                System.out.println("Items - list items available in location ");
                newLine();
